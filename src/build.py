    ...
    out.append(f'''    <header>
        <div class="container flex-row">
          <section class="brand">
            ...
            <nav>
                <a href="#" class="hero-active">Hem</a>
                <a href="mailto:{email}">Kontakt</a>
                <a href="#how" style="padding: 8px 20px;">Om Schackeffekt</a>
                <a href="#andreas" style="padding: 8px 20px;">Om Andreas</a>
            </nav>
        </div>
    </header>''')
...
{steps}            </div>
    ...
    if 'reviews' in sections:
        ...
        for i, item in enumerate(items):
            ...
            quotes += f'                            <p>{q}</p>\n'
            quotes += '                        </div>\n'
        out.append(f'''    <section id="reviews" class="section-bg-light split-section">
        <div class="container">
